...
//                    mCamera.autoFocus(LCameraTextureView.this);
    ...
    public void takePicture(@Nullable Camera.ShutterCallback shutter, @Nullable Camera.PictureCallback raw,
                            @Nullable Camera.PictureCallback postview, @Nullable Camera.PictureCallback jpeg) {
        if (mCamera != null) {
            try {
    ...
    public void setZoom(int value) {
        ...
        try {
            if (mCamera.getParameters().isZoomSupported()) {
                ...
                LogUtils.e(this.getClass().getSimpleName(), "Device zoom no supported.");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public int getMaxZoom() {
        if (mCamera == null) {
            LogUtils.e(this.getClass().getSimpleName(), "mCamera == null.");
            return -2;
        }
        if (mCamera.getParameters().isZoomSupported()) {
    ...
    public void startSmoothZoom(int value) {
        if (mCamera != null) {
            if (mCamera.getParameters().isSmoothZoomSupported()) {
                ...
                LogUtils.e(this.getClass().getSimpleName(), "Device smooth zoom no supported.");
            }
