package com.east.east_utils.utils.statusbar;
...
public class StatusBarUtil {
    ...
    /**
     * 代码实现android:fitsSystemWindows(这样保证状态栏 空间一直处于占据位置)
     *
     * @param activity
     */
     ...
     * @param color 颜色
     */
    public static void setStatusBarColor(Window window, @ColorInt int color, @IntRange(from = 0, to = 255) int statusBarAlpha) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (fakeStatusBarView != null) {
                ...
                decorView.addView(createStatusBarView(window, color, statusBarAlpha));
            }
        }
    }
     ...
     * @return 状态栏矩形条
     */
    private static View createStatusBarView(Window window, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        View statusBarView = new View(window.getContext());
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(window.getContext()));
     ...
     * @param drawableId
     */
    public static void setStatusBarDrawable(Activity activity, @DrawableRes int drawableId) {
