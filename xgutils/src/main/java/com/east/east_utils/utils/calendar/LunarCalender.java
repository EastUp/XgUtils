package com.east.east_utils.utils.calendar;
...
public class LunarCalender {
     ...
     * @return
     */
    public String getLunarString(int year, int month, int day,LunarType type){
...
//            animalsYear = year-1;
//        }
        String animalsYear = animalsYear(year);
        String festival = getFestival(year,month,day);
        //return lunY+"-"+lunM+"-"+lunD+"-"+animalsYear(animalsYear);
//        return "农历 "+lunM+lunD+" "+Festival;
//        return ""+lunM+" "+lunD+" ";
        if(type == LunarType.YearAnimalMonthDayFestival)
            return lunY+"["+animalsYear+"]"+" "+lunM+lunD+" "+festival;
        else if(type == LunarType.YearAnimalMonthDay)
            return lunY+"["+animalsYear+"]"+" "+lunM+lunD;
        else if(type == LunarType.YearMonthDayFestival)
            return lunY+" "+lunM+lunD+" "+festival;
        else if(type == LunarType.MonthDayFestival)
            return lunM+lunD+" "+festival;
        else if(type == LunarType.MonthDay)
            return lunM+lunD;
        else
            return lunM+lunD;
    }
