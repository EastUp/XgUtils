...
/**
 * 描述：获取农历的年月日
 * Created by East at 2018/5/11 16:30
 */
public class ChineseLanarUtils {
...
//        s += cyclical(getYearCyl()) + "年" + cyclical(getMonCyl()) + "月"+ cyclical(getDayCyl()) + "日";
        s =  cyclical(getYearCyl())+"("+Animals[sy]+")"+" 年 "+monthNong[getMonth()] + "月"+cDay(getDay());
        return s;
    }
